...
<jsp:useBean id="SearchMa" scope="page" class="kr.co.knoc.search.SearchManager" />
...
<div id="contents">
		...
		<div id="rightarea">
			<div id="subcnts">
				...
				<div class="pagetle">
					<h3><img src="/images/search/ttl_search.gif" alt="사이트 검색" /></h3>
				</div>
			  <div id="boardsec">
                	<p align="center" class="pb20">홈페이지에서 <span class="cDD0902_b">‘<%=key_word %>'</span>에 대해 <%=count %>개의 문서를 찾았습니다</p>
...
%>									
						<tr>
							<td><%=seq %></td>
							<td class="subj"><a href="<%=PropertyMa.getBoardPageUrl(sb.getBoardid()) %>?num=<%=sb.getBno() %>&amp;mode=view&amp;grp=<%=sb.getGrp() %>"><%=sb.getSubject() %></a></td>
